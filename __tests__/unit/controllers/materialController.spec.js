...
describe('material controller tests', () => {
    ...
    describe('show by binID', () => {
        ...
        beforeEach(() => {
            testMaterial = { material_id: 1, name: "paper", material_image: "image_link", bin_id: 2 }
            mockReq = { params: {id: 2 } }
        })

        test('return a material with a 200 status code', async () => {
            jest.spyOn(Material, 'getMaterialsByBinId')
    ...
    describe('show by not binID', () => {
        ...
        test('return a material with a 200 status code', async () => {
            jest.spyOn(Material, 'getMaterialsNotInBin')
                .mockResolvedValue(new Material(testMaterial))
